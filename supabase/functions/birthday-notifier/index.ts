...
//       return new Response(
//         JSON.stringify({ message: "No users found or no birthdays today." }),
//         {
//           status: 200,
//           headers: { "Content-Type": "application/json" },
//         }
...
//         return (
//           userBirthday.getMonth() + 1 === currentMonth &&
//           userBirthday.getDate() === currentDay
//         );
//       }
//       return false;
//     });
...
//           ${
//             user.favorite_fruit
//               ? `<p>Favorite Fruit: ${user.favorite_fruit}</p>`
//               : ""
//           }
...
//         console.error(
//           `Failed to send email for ${user.display_name}:`,
//           emailError
//         );
//       }
//     }
...
//     return new Response(
//       JSON.stringify({
//         message: `Birthday notifications sent for ${emailsSent.length} customers.`,
//         emailsSent,
//       }),
//       {
//         status: 200,
