        ...
        <div className="pb-6">
          <div className="flex flex-col gap-7">
            ...
            <div className="flex flex-col gap-3">
              <p className="h2-bold text-3xl text-[#1B6013]">Log in to your account</p>
              <p className="font-semibold text-lg">
                Don&apos;t have an account?
                <Link href={`/register?callbackUrl=${encodeURIComponent(callbackUrl)}`} className="text-blue-600 ml-1 relative group">
                  <span>Sign Up</span>
