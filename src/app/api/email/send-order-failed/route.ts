  ...
  try {
    ...
    const html = `
      <div style="font-family: Arial, sans-serif; background: #fff; max-width: 480px; margin: 0 auto; border: 1px solid #eaeaea; border-radius: 8px; padding: 24px;">
        ...
        <p style="font-size: 15px; color: #444;">If you believe this is a mistake or need help, please contact our support team at <a href="mailto:support@feedme.com.ng" style="color: #1B6013; text-decoration: underline;">support@feedme.com.ng</a> or call <b>+2348088282487</b>.</p>
