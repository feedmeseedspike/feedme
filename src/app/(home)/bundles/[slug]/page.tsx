...
const AISmartNudge = NextDynamic(() => import("@components/shared/ai/AISmartNudge"), { ssr: false });
  ...
  try {
    ...
    return (
      <>
        ...
        {/* AI Smart Nudge for bundle */}
        <AISmartNudge kind="bundle" productOrBundleName={transformedBundle.name} />
      </>
    );
  } catch (error) {
