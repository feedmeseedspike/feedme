...
import { Menu, X, Brain, Tag, FileText, Mail, Briefcase, Gift, Settings, Video, Bell, Heart } from "lucide-react";
...
export function AdminSidebar({ user }: AppSidebarProps) {
  ...
  const routes: Route[] = [
    ...
    { title: "Customer Reviews", url: "/admin/reviews", icon: Heart },
