  ...
  return (
    <>
      <motion.button
        ...
        className={
          className ??
          `fixed bottom-[calc(var(--sticky-cart-height,0px)_+_85px)] md:bottom-6 right-4 z-50 bg-[#1B6013]/90 text-white shadow-lg hover:bg-[#1B6013] transition-all flex items-center justify-center gap-2 overflow-hidden ${
            isChatWidgetOpen
