...
export default function ChatWidget({
  ...
  return (
    <AnimatePresence mode="wait">
      {isOpen && (
        <motion.div
          className="fixed bottom-[max(140px,calc(var(--sticky-cart-height,0px)_+_80px))] md:bottom-20 right-4 z-[85] w-[320px] sm:w-[360px] min-h-[280px] bg-[url('/images/whatsapp-background.jpg')] bg-cover bg-center rounded-2xl shadow-[0_20px_60px_rgba(0,0,0,0.3)] overflow-hidden"
